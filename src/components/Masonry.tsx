...
const Masonry: React.FC<MasonryProps> = ({
  ...
  }, [grid, animateFrom, blurToFocus]);

  useLayoutEffect(() => {
    if (!imagesReady || !isInView || !grid.length || hasAnimated.current) return;
    ...
    <div ref={containerRef} className="relative w-full h-full">
      {grid.map((item, index) => (
          <div
            ...
            onClick={() => (typeof onItemClick === 'function' ? onItemClick(index, item) : window.open(item.url, '_blank', 'noopener'))}
