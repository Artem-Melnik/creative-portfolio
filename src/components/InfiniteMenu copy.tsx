          ...
          >
            ...
            {orbitalItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <img src={process.env.NEXT_PUBLIC_URL + item.image} alt={item.title} className="h-full w-full object-cover" />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="relative h-full w-full overflow-hidden rounded-full border border-white/10 bg-zinc-950 shadow-[0_24px_90px_rgba(0,0,0,0.6)]">
                  <img src={process.env.NEXT_PUBLIC_URL + activeItem.image} alt={activeItem.title} className="h-full w-full object-cover" />
